    ...
    <div class="container-fluid">
        <div class="row navbar-row">
            <div class="col-6 mobile-logo">
                <a href="<?php echo e(route('index')); ?>"> <img src="<?php echo e(asset($settings->logo)); ?>" alt="Logo"> </a>
            </div>
            <div class="col-6 navbar-icons">
                <div class="row justify-content-center">
                    <div class="col">
                        <!-- <img src="<?php echo e(asset('img/icons/user-avatar.svg')); ?>" alt="account" id="user-icon-nav" class="menu-icon"> -->
                    </div>
                    <div class="col">
                        <!-- <img src="<?php echo e(asset('img/icons/search.svg')); ?>" alt="search" class="menu-icon" id="search-icon"> -->
                    </div>
                    <div class="col">
                        <svg class="menu-icon menu-list-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 78.1 59.4"><title>menu</title><path d="M4.8,10H73.2c6.4,0,6.4-10,0-10H4.8c-6.4,0-6.4,10,0,10Z" fill="#00b9ff"/><path d="M4.8,34.7H73.2c6.4,0,6.4-10,0-10H4.8c-6.4,0-6.4,10,0,10Z" fill="#00b9ff"/><path d="M5,59.4H73.3c6.4,0,6.4-10,0-10H5c-6.5,0-6.5,10,0,10Z" fill="#00b9ff"/></svg>
                    </div>
                </div>
            </div>
        </div>
...
<div class="mobile-menu-div">
    <div class="menu-div-inner">
        <ul>
            ...
            <?php else: ?>
            <li>
                <a href="<?php echo e(route('myaccount')); ?>">My Account</a>
            </li>
            <?php if(Auth::user()->admin): ?>
            <li>
                <a href="<?php echo e(route('dashboard')); ?>">Admin Panel</a>
            </li>
            <?php endif; ?>
            <li>
...
<?php /**PATH D:\wamp64\www\Laravel\cyber\resources\views/inc/nav.blade.php ENDPATH**/ ?>