<div class="row">
    <div class="col user-details-col">
        <a href="{{ route('index') }}"> <img id="logo" src="{{ asset($settings->logo) }}" alt="Logo"> </a>
        <img src="{{ asset($admin->profile->avatar) }}" alt="Avatar" id="avatar">
        <h5 class="text-center mt-2 text-capitalize">{{ $admin->username }}</h5>
        <hr>
    </div>
</div>
<div class="row">
    <div class="col dashboard-menu">
        <ul>
            <li class="li-menu @if($page == 'dashboard') menu-active @endif">
            ...
            <li class="li-menu @if($page == 'users') menu-active @endif">
            ...
            <li class="li-menu @if($page == 'posts') menu-active @endif">
            ...
            <li class="li-menu @if($page == 'categories') menu-active @endif">
            ...
            <li class="li-menu @if($page == 'tags') menu-active @endif">
            ...
            <li class="li-menu @if($page == 'menu') menu-active @endif">
            ...
            <li class="li-menu @if($page == 'footer') menu-active @endif">
            ...
            <li class="li-menu @if($page == 'settings') menu-active @endif">
            ...
            <li class="li-menu li-sub-menu @if( isset($subPage) ) @if($subPage == 'settings-home') sub-menu-active @endif @elseif($page != 'settings') d-none @endif">
                <a href="{{ route('settings.home') }}">Homepage</a>
            </li>
        </ul>
    </div>
</div>
