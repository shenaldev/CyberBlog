    ...
    <div class="col">
        ...
        <div class="row">
            <div class="col welcome-col">
                <h1>Welcome To Dashboard {{ $admin->username }}</h1>
            </div>
        </div>
        ...
        <div class="row dashboard-links-row">
            <div class="col-lg-3 col-md-6 col-sm-12 text-center">
                <a href="{{ route('post.create') }}" class="btn-blue">Add New Post</a>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 text-center">
                <a href="{{ route('user.create') }}" class="btn-blue">Add New User</a>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 text-center">
                <a href="{{ route('category.create') }}" class="btn-blue">Create Category</a>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 text-center">
                <a href="{{ route('tag.index') }}" class="btn-blue">Create Tag</a>
            </div>
        </div>
