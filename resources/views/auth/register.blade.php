            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <h6>Signup Using Social Media</h6>
                    </div>
                    <div class="social-login-div text-center mt-3">
                        <a href="{{ route('social.login', ['provider' => 'facebook']) }}" class="social-btn fb-btn">
                            <div class="btn-inner">
                    ...
                    <a href="{{ route('social.login', ['provider' => 'google']) }}" class="social-btn google-btn">
                            <div class="btn-inner">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                                    <span class="invalid-feedback d-none" id="username-error" role="alert">
